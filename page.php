<?php get_header(); ?>
    ...
    <div id="home" class="content has-bg home">
        ...
        <div class="content-bg">
            <img src="http://www.uniteinvest.co.uk/wp-content/uploads/2017/02/home-bg.jpg" alt="Home">
        </div>
    ...
    <div id="what" class="content has-bg">
        ...
        <div id="investment-briefs" class="content">
            <div class="container">
               <h2 class="content-title">Investment Briefs</h2>
            </div>
        </div>
    ...
    <div id="join" class="content has-bg">
        ...
        <div id="pricing" class="content">
            <div class="container">
               <h2 class="content-title">Pricing</h2>
                    <p class="content-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum consectetur eros dolor, sed bibendum turpis luctus eget</p>
        ...
        <div id="find-out-more" class="content">
            <div class="container">
                    <h2 class="content-title">Find Out More</h2>
                    <p class="content-desc">
                        Phasellus suscipit nisi hendrerit metus pharetra dignissim. Nullam nunc ante, viverra quis<br>
                        ex non, porttitor iaculis nisi.
                    </p>
    ...
    <div id="contact" class="content has-bg">
        ...
        <div id="contact-us" class="content bg-silver-lighter">
        <div class="container">
...
sed bibendum turpis luctus eget</p>
        ...
        <div id="press" class="content">
            <div class="container">
                    <h2 class="content-title">Press / Media Contact</h2>
                    <p class="content-desc">
                        Phasellus suscipit nisi hendrerit metus pharetra dignissim. Nullam nunc ante, viverra quis<br>
                        ex non, porttitor iaculis nisi.
                    </p>
